        ...
        <div className="max-w-6xl mx-auto">
              ...
              <div className="flex flex-col items-center text-center">
                ...
                <div className="space-y-2 w-full">
                  <button 
                    ...
                    className="flex items-center gap-2 p-2 rounded bg-muted/30 border border-border/50 hover:bg-primary/10 hover:border-primary/30 transition-colors w-full"
                  >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <Card className="p-8 bg-card border-border text-center">
              <h3 className="text-xl font-semibold mb-2">Start New Intake Session</h3>
              <p className="text-muted-foreground mb-6">
                Capture business requirements through voice recording and live transcription
              </p>
              <Button size="lg" onClick={handleStartIntake} className="gap-2">
            ...
            <Card className="p-8 bg-card border-border text-center">
              <h3 className="text-xl font-semibold mb-2">Voice Capture Demo</h3>
              <p className="text-muted-foreground mb-6">
                Test voice recording and live transcription features
              </p>
              <Button size="lg" onClick={handleVoiceDemo} variant="outline" className="gap-2">
                <Mic className="h-4 w-4" />
                Try Demo
              </Button>
            </Card>
            ...
            <Card className="p-8 bg-card border-border text-center">
              ...
              <p className="text-muted-foreground mb-6">
                Explore organizations, products, workflows, and steps that have been processed
              </p>
              <Button size="lg" onClick={handleViewOrganizations} variant="outline" className="gap-2">
