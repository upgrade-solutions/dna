...
// ---------------------------------------------------------------------------
// External-system shapes — replace these with the real API's response shapes.
// ---------------------------------------------------------------------------
...
export interface Client {
  listItems(options?: { cursor?: string }): Promise<ExternalListResponse>
  ...
  pushDna(dna: DnaInput): Promise<{ created: number }>
}

// ---------------------------------------------------------------------------
// Webhook event shapes. Replace with the real provider's webhook payloads.
// ---------------------------------------------------------------------------
