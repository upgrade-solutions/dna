import type { ParseResult as CoreParseResult } from '@dna-codes/dna-core';
 ...
 *
 * The canonical contract lives in `@dna-codes/dna-core` so other consumers
 * (integrations, ingest) can name it without depending on this package.
 */
