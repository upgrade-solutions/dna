...
export const SECONDARY_BACKGROUND_COLOR = '#252526';
export const LIGHT_COLOR = '#212121';
...
// icons (white fill for dark mode compatibility)
export const MESSAGE_ICON = 'data:image/svg+xml;base64,';
export const USER_INPUT_ICON = 'data:image/svg+xml;base64,';
