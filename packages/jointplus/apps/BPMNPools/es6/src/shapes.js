...
export class HorizontalPool extends shapes.bpmn2.HeaderedHorizontalPool {
    defaults() {
        return util.defaultsDeep(Object.assign(Object.assign({}, poolAttributes), { type: 'custom.HorizontalPool', headerSide: 'top', padding: { top: POOL_HEADER_SIZE, left: 0 }, attrs: {
                header: {
                    stroke: '#000000',
                    fill: '#d3d3d3'
                },
                headerText: Object.assign({ fill: '#333333' }, fontAttributes)
            } }), super.defaults);
    }
...
export class VerticalPool extends shapes.bpmn2.HeaderedVerticalPool {
    defaults() {
        return util.defaultsDeep(Object.assign(Object.assign({}, poolAttributes), { type: 'custom.VerticalPool', headerSide: 'left', padding: { top: 0, left: POOL_HEADER_SIZE }, attrs: {
                header: {
                    stroke: '#000000',
                    fill: '#d3d3d3'
                },
...
export class HorizontalSwimlane extends shapes.bpmn2.HorizontalSwimlane {
    defaults() {
        return util.defaultsDeep(Object.assign(Object.assign({}, swimlaneAttributes), { type: 'custom.HorizontalSwimlane', attrs: {
                header: {
                    stroke: '#000000',
                    fill: '#f2f2f2'
                },
...
export class VerticalSwimlane extends shapes.bpmn2.VerticalSwimlane {
    defaults() {
        return util.defaultsDeep(Object.assign(Object.assign({}, swimlaneAttributes), { type: 'custom.VerticalSwimlane', attrs: {
                header: {
                    stroke: '#000000',
                    fill: '#f2f2f2'
                },
...
export class HorizontalPhase extends shapes.bpmn2.HorizontalPhase {
    defaults() {
        return util.defaultsDeep(Object.assign(Object.assign({}, phaseAttributes), { type: 'bpmn.HorizontalPhase', attrs: {
                header: {
                    stroke: '#000000',
                    fill: '#f2f2f2'
                },
...
export class VerticalPhase extends shapes.bpmn2.VerticalPhase {
    defaults() {
        return util.defaultsDeep(Object.assign(Object.assign({}, phaseAttributes), { type: 'bpmn.VerticalPhase', attrs: {
                header: {
                    stroke: '#000000',
                    fill: '#f2f2f2'
                },
