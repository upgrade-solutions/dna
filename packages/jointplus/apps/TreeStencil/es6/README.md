# JointJS+ Tree Stencil Application

Interactively visualize hierarchical data in a collapsible tree stencil that can be expanded and minimized up to any level.
