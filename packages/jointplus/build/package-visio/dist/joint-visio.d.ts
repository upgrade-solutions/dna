...
export class VisioShape extends VisioSheetObject {
    ...
    static fromMaster(master: VisioMaster, page: VisioPage): Promise<VisioShape>;
...
export namespace VisioPage {
    ...
    interface FromPaperAttributes {
        ...
        portConnectionPoint?: ((port: dia.Element.Port, elementView: dia.ElementView) => dia.Point);
