...
function createClient(options) {
    ...
    async function pullDnaFromEpic(key, pullOptions) {
    ...
    async function updateStoriesUnderEpic(key, dna, style = 'user-story') {
        ...
        for (const doc of docs) {
            ...
            await updateIssue(issueKey, {
                summary: doc.title,
                description: (0, adf_1.fromMarkdown)(doc.body),
    ...
    async function pushStoriesToEpic(key, dna, pushOptions = {}) {
        const issueType = pushOptions.issueType ?? storyIssueType;
        const stories = (0, mapping_1.dnaToStoryFields)(dna, {
            ...
            return {
                ...
                planned: stories.map((s) => ({
                    ...
                    description: typeof s.description === 'string'
                        ? s.description
                        : (0, adf_1.extractText)(s.description),
                })),
            };
        }
        const created = [];
        for (const fields of stories) {
            const adfFields = {
                ...
                description: typeof fields.description === 'string'
                    ? (0, adf_1.fromMarkdown)(fields.description)
                    : fields.description,
            };
