...
- **Two Resources serving as Groups**: both `Listing` and `Booking` are tracked entities AND scoping units. Demonstrates that the Group "kind" isn't tied to one specific kind of Resource.
